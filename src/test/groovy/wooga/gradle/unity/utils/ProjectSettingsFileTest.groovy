...
class ProjectSettingsFileTest extends UnityAssetFileTest {

    @Override
    Class<UnityAssetFile> getClassImp() {
        return ProjectSettingsFile.class
    }

    static String TEMPLATE_CONTENT = ProjectSettingsFile.DEFAULT_TEMPLATE_CONTENT
    ...
    def "parse playModeTestRunnerDisabled with #objectType"() {
        when:
        def settings = new ProjectSettingsFile(content)
    ...
    def "playModeTestRunnerEnabled returns false with invalid project settings file"() {
        ...
        ProjectSettingsFile settings = new ProjectSettingsFile(content)
    ...
    def "serializes file correctly"() {
        ...
        def settings = new ProjectSettingsFile(file)
        ...
        then:
        def updatedSettings = new ProjectSettingsFile(file)
