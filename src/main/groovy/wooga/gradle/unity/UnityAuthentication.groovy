...
class UnityAuthentication implements Authentication {
    ...
    UnityAuthentication(Map<String, ?> properties, Map<String, ?> env) {
        this.properties = properties
        this.env = env
    }

    UnityAuthentication(String username, String password, String serial) {
        this.username = username
        this.password = password
        this.serial = serial
        this.env = [:]
